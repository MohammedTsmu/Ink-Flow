...
export default function Dashboard({ printers, onAddPrinter, onEditPrinter, onRefresh, onDetectPrinters, onShowHistory, onShowSettings, onShowStats, onShowDiagnostics, onShowPrinterHistory }: DashboardProps) {
    ...
    <div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button onClick={onShowDiagnostics} className={btnClass} title="Activity log — see what Ink Flow has been doing">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
